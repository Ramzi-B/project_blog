...
$sql = 'SELECT authors.id, authors.authorName, authors.authorEmail FROM authors';
...
<head>
    ...
    <!-- Title -->
    <title>Les autheurs</title></title>
    <!-- Font Awesome CDN -->
    ...
    <main class="container">
        ...
        <?php foreach ($authors as $author): ?>
            ...
            <article class="card">
                ...
                <p><?= validate($author->authorName) ?></p>
                <p><?= validate($author->authorEmail) ?></p>

                <a class="btn" href="/editAuthor.php?id=<?= intval($author->id) ?>">Modifier</a>

                <form action="/deleteAuthor.php?id=<?= intval($author->id) ?>" method="POST"
